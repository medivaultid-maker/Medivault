...
export default function HistologiPage() {
  return (
    <InfoLayout>

      <InfoHero
        title="Histologi"
        subtitle="Rangkuman materi histologi yang disusun per bab untuk membantu memahami struktur mikroskopis jaringan dan organ tubuh dengan lebih mudah."
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="rounded-[32px] border border-slate-100 bg-white p-8 shadow-[0_14px_40px_rgba(6,27,58,0.06)] md:p-10">
            ...
            <div className="overflow-hidden rounded-[24px] border border-slate-100 bg-slate-50">
              <img
                src="/images/histologi-preview.png"
                alt="Preview Catatan Materi Histologi"
            ...
            <div className="mt-10">
              ...
              <h2 className="text-2xl font-black text-[#061B3A]">
                Catatan Materi — Histologi
              </h2>

              <p className="mt-4 leading-7 text-slate-600">
                Catatan materi Histologi yang merangkum berbagai jenis jaringan,
                struktur mikroskopis, serta karakteristik histologis organ tubuh
                secara ringkas dan sistematis untuk membantu proses belajar dan
                persiapan ujian.
              </p>
              ...
              <div className="mt-8 space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-slate-600">
                    Rangkuman struktur dan karakteristik histologis secara ringkas
                  </p>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-slate-600">
                    Membantu memahami gambaran mikroskopis jaringan dan organ sebelum ujian
                  </p>
                </div>
